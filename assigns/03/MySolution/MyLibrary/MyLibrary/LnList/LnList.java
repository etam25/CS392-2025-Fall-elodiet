...
public class LnList<T> {
    ...
    public final LnListSUtil SU = new LnListSUtil();
    public final LnListUtil U0 = new LnListUtil();
    ...
    public void rforitm1(Consumer<? super T> work) {
        Node xs = root;
        Node ys = null;
        while (xs != null) {
    ...
    public void rforitm0(Consumer<? super T> work) {
        rforitm1(work);
        root = null;
        return;
    }
