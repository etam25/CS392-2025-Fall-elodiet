...
public abstract class FnGseq<XS, X0> {
    ...
    public XS list$make(FnList<X0> xs) {
        throw new FnGseqExn();
    }

    public XS array$make(FnA1sz<X0> xs) {
        return list$make(xs.listize());
    }

    public void System$out$print(XS xs) {
    ...
    public <R0> R0 rfolditm (XS xs, R0 r0, BiFunction<? super X0, R0, R0> fopr) {
        return FnListSUtil.folditm (rlistize(xs), r0, (R0 r1, X0 x0) -> fopr.apply(x0, r1));
    }
    ...
    public FnList<X0> mergeSort_list (XS xs, ToIntBiFunction<X0, X0> cmp) {
        return FnListSUtil.mergeSort(listize(xs), cmp);
    }

    public FnA1sz<X0> mergeSort_array (XS xs, ToIntBiFunction<X0, X0> cmp) {
    ...
    public FnList<X0> quickSort_list (XS xs, ToIntBiFunction<X0, X0> cmp) {
    ...
    public FnList<X0> insertSort_list (XS xs, ToIntBiFunction<X0, X0> cmp) {
