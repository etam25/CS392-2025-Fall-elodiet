...
public class FnA1sz<T> {
    ...
    public final FnA1szSUtil SU = new FnA1szSUtil();
    public final FnA1szUtil<T> U0 = new FnA1szUtil<T>();
    ...
    public FnList<T> listize() { return this.U0.listize(this); }
    public FnList<T> rlistize() { return this.U0.rlistize(this); }
