...
public class FnStrn {
    ...
    public final FnStrnUtil U0 = new FnStrnUtil();
    public final FnStrnSUtil SU = new FnStrnSUtil();
    ...
    public FnStrn append(FnStrn xs) {
        int n0 = root.length;
        int n1 = xs.length();
    ...
    public FnStrn mergeSort() {
        return mergeSort((c1, c2) -> c1.compareTo(c2));
    }

    public FnStrn insertSort() {
        return insertSort((c1, c2) -> c1.compareTo(c2));
    }

    public FnStrn mergeSort(ToIntBiFunction<Character, Character> cmp) {
        return this.U0.mergeSort(this, cmp);
    }

    public FnStrn insertSort(ToIntBiFunction<Character, Character> cmp) {
